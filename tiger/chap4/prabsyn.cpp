...
void pr_exp(FILE *out, A_exp v, int d) {
  ...
  switch (v->kind) {
    ...
    case A_exp_::A_forExp:
      ...
      break;
    case A_exp_::A_breakExp:
      fprintf(out, "breakExp()");
      break;
    case A_exp_::A_letExp:
      fprintf(out, "letExp(\n");
